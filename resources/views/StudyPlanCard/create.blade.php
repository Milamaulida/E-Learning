...
<body>
    <br>
    <br>
    <center><h1 class="text-center mb-4">Tambah Data Study Plan Card</h1></center><br>
    <form action="/studyplancard/store" method="post">
        {{ csrf_field() }}
        <div class="container">
                ...
                <div class="col-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="studyplancard" class="btn btn-primary">Kembali</a> 
                        </div>
                </div>
            </div>
        </div>
